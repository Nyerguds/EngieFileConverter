...
namespace SimplePaletteQuantizer.Extensions
{
    ...
    public static partial class Extend
    {
        ...
        public static void SetPalette(this Image image, List<Color> palette)
        {
            ...
            {
                String message = string.Format("Cannot store a palette with {0} colors into an image palette where only {1} colors are allowed.", palette.Count, imagePalette.Entries.Length);

...
namespace SimplePaletteQuantizer.Quantizers
{
    public abstract class BaseColorQuantizer : IColorQuantizer
    {
        ...
        protected readonly Dictionary<Int32, Int16> UniqueColors;
        ...
        protected BaseColorQuantizer()
        {
            pathProvider = null;
            uniqueColorIndex = -1;
            UniqueColors = new Dictionary<Int32, Int16>();
        }
        ...
        {
            if (!this.UniqueColors.ContainsKey(key))
                UniqueColors.Add(key, (Byte)(++this.uniqueColorIndex));
        }

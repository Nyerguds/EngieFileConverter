...
namespace Nyerguds.GameData.Westwood
{
    public class WestwoodRleZero
    {
        ...
        public static Byte[] DecompressRleZero(Byte[] fileData, ref Int32 offset, Int32 frameWidth, Int32 frameHeight)
        {
        ...
        public static Byte[] CompressRleZero(Byte[] imageData, Int32 frameWidth, Int32 frameHeight)
        {
